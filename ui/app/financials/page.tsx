...
export default function FinancialsPage() {
  ...
  return <AppShell>
    <header className="page-heading"><div><p className="eyebrow">Financial trends</p><h1>Normalized financial history</h1><p>Filter exact concept mappings while retaining period basis, confidence, accession, and fact-level provenance.</p></div><div className="run-status">{data.factCount} prepared facts</div></header>
