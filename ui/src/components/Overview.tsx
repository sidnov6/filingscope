...
export function Overview() {
  ...
  const coverage = [
    { label: "SEC filing records", value: String(data.filings.length), detail: "10-K · 10-Q · 8-K when available" },
    { label: "Normalized facts", value: String(data.facts.length), detail: `Mapping ${data.quality.mappingVersion}` },
